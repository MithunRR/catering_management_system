...
<body>
    ...
    echo '<h1 style="padding-top: 52px !important; text-align: center">Desserts</h1>';
    echo '<div class="product-container">';
    $result = $conn->query("SELECT * FROM menu_items WHERE category='Desserts'");
    ...
    echo '<h1 style="padding-top: 52px !important; text-align: center">Ice Cream</h1>';
    echo '<div class="product-container">';
    $result = $conn->query("SELECT * FROM menu_items WHERE category='Ice Cream'");
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            // Fetch product details from menu_items table
            $productName = $row['name'];

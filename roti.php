...
<body>
    ...
    echo '<h1 style="padding-top: 52px !important; text-align: center">Roti/Paratha/Bread</h1>';
    echo '<div class="product-container">';
    $result = $conn->query("SELECT * FROM menu_items WHERE category='Roti/Paratha/Bread'");

...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["item_name"])) {
    ...
    $sql = "INSERT INTO menu_chinese (name, category, price, descr, img) 
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update_name"])) {
  ...
  $currentDataQuery = "SELECT name, category, price, descr, img FROM menu_chinese WHERE id = $item_id";
  ...
  if ($name != $currentData['name'] ||
    ...
    $stmt = $conn->prepare("UPDATE menu_chinese SET name=?, category=?, price=?, descr=?, img=? WHERE id=?");
    ...
    $updateImgQuery = "UPDATE menu_chinese SET img='$img' WHERE id=$item_id";
...
//   $delete_query = "DELETE FROM menu_chinese WHERE id = '$item_id'";
//   }
//   // header("location: basic-table.php");
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $item_id = mysqli_real_escape_string($conn, $_POST["item_id"]);
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Menu Items | Chinese</h4>
                </div>
                <div>
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-1">
                    <table class="table table-bordered">
                      ...
                      <?php 
                        include __DIR__ . '/../../../connection.php';
                        $sql = "SELECT id, name, price FROM menu_chinese WHERE category='Rice'";
                        $rice_cat_data = mysqli_query($conn, $sql);
                        $rice_row = mysqli_num_rows($rice_cat_data);
                        if($rice_row>0){
                          $counter = 1;
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      <?php 
                        include __DIR__ . '/../../../connection.php';
                        $sql = "SELECT id, name, price FROM menu_chinese WHERE category='Noodles'";
                        $rice_cat_data = mysqli_query($conn, $sql);
                        $rice_row = mysqli_num_rows($rice_cat_data);
                        if($rice_row>0){
                          $counter = 1;
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      <?php 
                        include __DIR__ . '/../../../connection.php';
                        $sql = "SELECT id, name, price FROM menu_chinese WHERE category='Roti/Paratha/Bread'";
                        $rice_cat_data = mysqli_query($conn, $sql);
                        $rice_row = mysqli_num_rows($rice_cat_data);
                        if($rice_row>0){
                          $counter = 1;
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      <?php 
                        include __DIR__ . '/../../../connection.php';
                        $sql = "SELECT id, name, price FROM menu_chinese WHERE category='Main Course'";
                        $rice_cat_data = mysqli_query($conn, $sql);
                        $rice_row = mysqli_num_rows($rice_cat_data);
                        if($rice_row>0){
                          $counter = 1;
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      <?php 
                        include __DIR__ . '/../../../connection.php';
                        $sql = "SELECT id, name, price FROM menu_chinese WHERE category='Curries'";
                        $rice_cat_data = mysqli_query($conn, $sql);
                        $rice_row = mysqli_num_rows($rice_cat_data);
                        if($rice_row>0){
                          $counter = 1;
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      <?php 
                        include __DIR__ . '/../../../connection.php';
                        $sql = "SELECT id, name, price FROM menu_chinese WHERE category='Sweet'";
                        $rice_cat_data = mysqli_query($conn, $sql);
                        $rice_row = mysqli_num_rows($rice_cat_data);
                        if($rice_row>0){
                          $counter = 1;
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      <?php 
                        include __DIR__ . '/../../../connection.php';
                        $sql = "SELECT id, name, price FROM menu_chinese WHERE category='Chat'";
                        $rice_cat_data = mysqli_query($conn, $sql);
                        $rice_row = mysqli_num_rows($rice_cat_data);
                        if($rice_row>0){
                          $counter = 1;

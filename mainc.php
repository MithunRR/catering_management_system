...
<body>
    ...
    echo '<h1 style="padding-top: 52px !important; text-align: center">Sabji</h1>';
    echo '<div class="product-container">';
    $result = $conn->query("SELECT * FROM menu_items WHERE category='Sabji'");
    ...
    echo '<h1 style="padding-top: 52px !important; text-align: center">Roti/Naan</h1>';
    echo '<div class="product-container">';
    $result = $conn->query("SELECT * FROM menu_items WHERE category='Roti/Naan'");
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            // Fetch product details from menu_items table
            $productName = $row['name'];
